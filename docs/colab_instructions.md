...
This creates *your own* version of the notebook.  
You will be the owner of the copy and you can edit and run everything safely.
...
Some code cells are designed for you to modify as part of the exercise.

In those cells, you may:
